...
public class KeyHandler implements DeviceKeyHandler {
    ...
    static {
        ...
        sSupportedSliderRingModes.put(Constants.KEY_VALUE_TOTAL_SILENCE, AudioManager.RINGER_MODE_SILENT);
        sSupportedSliderRingModes.put(Constants.KEY_VALUE_ALARMS_ONLY, AudioManager.RINGER_MODE_SILENT);
