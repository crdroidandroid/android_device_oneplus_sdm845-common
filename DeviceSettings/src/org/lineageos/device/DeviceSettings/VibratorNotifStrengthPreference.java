...
public class VibratorNotifStrengthPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public static boolean isSupported() {
        return Utils.fileWritable(FILE_NOTIF_LEVEL);
    }

    public static String getValue(Context context) {
        return Utils.getFileValue(FILE_NOTIF_LEVEL, "3596");
    }

    private void setValue(String newValue, boolean withFeedback) {
        Utils.writeValue(FILE_NOTIF_LEVEL, newValue);
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(DeviceSettings.KEY_NOTIF_VIBSTRENGTH, "3596");
        Utils.writeValue(FILE_NOTIF_LEVEL, storedValue);
    }
